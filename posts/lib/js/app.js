...
const APP = new class {
    ...
    getPost(postId) {
        ...
        /** @type {BehaviorSubject<{ author: { $id: BehaviorSubject<string>, $name: BehaviorSubject<string>, $color: BehaviorSubject<string>, $url: BehaviorSubject<string> }, $message: BehaviorSubject<string>, $created: BehaviorSubject<number>, $updated: BehaviorSubject<number> }[]>} */
